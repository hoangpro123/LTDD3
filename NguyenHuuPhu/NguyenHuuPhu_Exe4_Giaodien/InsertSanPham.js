  ...
  Insert_Data_Into_MySQL = () =>
    {
        ...
        {
            fetch('http://10.0.2.2:80/webservice/insert-sanPham.php',
            {
                method: 'POST',
                headers: 
                {
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <TouchableHighlight style={[styles.buttonContainer, styles.loginButton]} onPress={() => this.Insert_Data_Into_MySQL()}>
